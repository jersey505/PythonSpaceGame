...
PLAYER_NAME = "Player"
FRIEND1_NAME = "Your friend"
FRIEND2_NAME = "Your other friend"
current_room = 31
...
def game_loop():
    ...
    if keyboard.q and item_carrying:
...
def hazard_move():
    ...
    for hazard in current_room_hazards_list:
        ...
        if hazard_direction == 1:
            hazard_y -= 1
        if hazard_direction == 2:
            hazard_x += 1
        if hazard_direction == 3:
            hazard_y += 1
